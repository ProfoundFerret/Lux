...
#define kSHOW_IN_PLAYLIST NSLocalizedString(@"Show In Playlist",nil)
#define kADD_TO_PLAYLIST_TEXT NSLocalizedString(@"Add To Playlist",nil)
#define kNEW_PLAYLIST NSLocalizedString(@"New Playlist",nil)
...
#define kMUSIC_FOLDER NSLocalizedString(@"Music",nil)
...
#define kNOTHING_PLAYING NSLocalizedString(@"Nothing Playing",nil)
