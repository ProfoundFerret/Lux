...
#define kNEXT_TEXT @"Suivant"
#define kPREVIOUS_TEXT @"Précédent"
#define kPLAY_RECENT_TEXT @"Play Recent"
#define kREPEAT_TEXT @"Répéter"
#define kSHUFFLE_TEXT @"Mélanger"
#define kIT_IS_PAUSED @"(En Pause)"
#define kSHOW_IN_FINDER_TEXT @"Afficher dans le Finder"
#define kSHOW_IN_PLAYLIST @"Afficher dans la Playlist"
#define kADD_TO_PLAYLIST_TEXT @"Ajouter à la Playlist"
#define kNEW_PLAYLIST @"Nnouvelle Playlist"
#define kDELETE_FROM_TEXT @"Supprimer depuis"
#define kDELETE_FROM_LIBRARY_TEXT @"Supprimer depuis la librairie"
...
#define kFILES_COUNT_TEXT @"%d Fichiers"
#define kFILE_COUNT_TEXT @"%d Cichier"
...
#define kUNTITLED_PLAYLIST @"Playlist sans titre"

#define kSMART_SEARCH_DELIMITER @"?"

#define kMUSIC @"Musique"
#define kVIDEO @"Vidéo"
